...
### [AI Meets Control for Resilient and Reliable Robot Planning (AIM-Ctrl) @ IROS 2026 (Pittsburgh, US)](https://sites.google.com/view/aim-ctrl/home-page?authuser=0)

**Daniele Meli**, **Francesco Trotti**, and **Alessandro Farinelli**, together with [Dr. Mattia Piccinini](https://mattiapiccinini95.github.io/) and [Prof. Johannes Betz](https://www.mos.ed.tum.de/avs/team/prof-dr-ing-johannes-betz/) (Technical University of Munich, DE), are pleased to announce the **AIM‑Ctrl Workshop on AI Meets Control for 
Resilient and Reliable Robot Planning**. The event brings together researchers from AI planning, robotics, and control theory to explore how learning‑based adaptability and control‑driven structure can be jointly leveraged to achieve reliable, resilient, and predictable long‑horizon behavior in autonomous systems.
The workshop welcomes contributions on shared representations for goals, constraints, and uncertainty; hybrid planning schemes that integrate RL, MPC, TAMP, and neural or diffusion planners; mechanisms to prevent long‑term drift such as safety shields or certified policy updates; and evaluation methodologies that capture robustness under distribution shift and cumulative degradation. By fostering dialogue across traditionally separate communities, AIM‑Ctrl aims to define a unified research agenda for autonomous robots capable of sustained, trustworthy operation in dynamic environments.

### [Workshop on Neuro-Symbolic Intelligence for LLMs and Autonomous Agents (NILA) @ IJCAI-ECAI 2026 (Bremen, DE)](https://sites.google.com/view/nila-workshop-ijcai-2026/home?authuser=0)

**Celeste Veronese** and **Daniele Meli** are pleased to announce the Workshop on Neuro‑Symbolic Intelligence for LLMs and Autonomous Agents, which will take place at IJCAI‑ECAI 2026 in Bremen, Germany. Co-organized with **[Alessandra Russo (Imperial College London)](https://profiles.imperial.ac.uk/a.russo)**, **[Abulhair Saparov (Purdue University)](https://asaparov.org/)**, **[Djallel Bouneffouf (IBM)](https://www.linkedin.com/in/djallel-bouneffouf-981b4b15/)** and **[Pranava Madhyastha (City St. George University London)](https://pmadhyastha.github.io/)**, the workshop brings together researchers from academia and industry to explore how neurosymbolic AI can advance the next generation of large language models and autonomous agents. By fostering dialogue across communities working on reasoning, learning, planning, and interaction, the event aims to consolidate emerging ideas and shape the future of hybrid intelligent systems.
The workshop welcomes contributions that investigate how symbolic structures and sub‑symbolic models can be combined to support more capable, explainable, and trustworthy agents. Topics of interest include neurosymbolic approaches for autonomous and multi‑agent systems, the integration of LLMs with reasoning and planning, the development of world models and symbolic action representations, and methods for learning abstractions from raw data. We are also interested in work addressing interpretability, verification, hybrid architectures for perception and action, human‑in‑the‑loop knowledge integration, and the design of benchmarks and real‑world evaluations.

### [Neurosymbolic Decision Making for Autonomous Agents @ AAMAS 2026 (Cyprus)](https://sites.google.com/view/aamas2026-nesy-tutorial/)
...
### [GardAI 2026](https://isla-lab.github.io/events/gardai/)
